...
impl Into<[u8; constants::SECRET_KEY_SIZE]> for SecretKey {
    fn into(self) -> [u8; constants::SECRET_KEY_SIZE] {
        self.0
    }
}
...
mod test {
    ...
    fn test_pubkey_serialize() {
        ...
        assert_eq!(
            ...
            &[
                4, 149, 16, 196, 140, 38, 92, 239, 179, 65, 59, 224, 230, 183, 91, 238, 240, 46,
                186, 252, 175, 102, 52, 249, 98, 178, 123, 72, 50, 171, 196, 254, 236, 1, 189, 143,
                242, 227, 16, 87, 247, 183, 162, 68, 237, 140, 92, 205, 151, 129, 166, 58, 111, 96,
                123, 64, 180, 147, 51, 12, 209, 89, 236, 213, 206
            ][..]
        );
        assert_eq!(
            &pk1.serialize()[..],
            &[
                2, 149, 16, 196, 140, 38, 92, 239, 179, 65, 59, 224, 230, 183, 91, 238, 240, 46,
                186, 252, 175, 102, 52, 249, 98, 178, 123, 72, 50, 171, 196, 254, 236
            ][..]
        );
    }
